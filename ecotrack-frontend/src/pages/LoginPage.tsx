    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-gray-100 px-4 py-8 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">EcoTrack</h1>
          <p className="text-gray-600 text-sm sm:text-base mt-3">Track your carbon footprint</p>
        </div>
