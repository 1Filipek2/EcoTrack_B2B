...
export default function RegisterPage() {
    ...
    var _d = useState(''), companyName = _d[0], setCompanyName = _d[1];
    var _e = useState(''), vatNumber = _e[0], setVatNumber = _e[1];
    var _f = useState(''), verificationCode = _f[0], setVerificationCode = _f[1];
    var _g = useState(''), error = _g[0], setError = _g[1];
    var _h = useState(''), success = _h[0], setSuccess = _h[1];
    var _j = useState(false), loading = _j[0], setLoading = _j[1];
    var _k = useState('register'), step = _k[0], setStep = _k[1];
    var _l = useState(false), resendLoading = _l[0], setResendLoading = _l[1];
    var _m = useState(''), resendMessage = _m[0], setResendMessage = _m[1];
